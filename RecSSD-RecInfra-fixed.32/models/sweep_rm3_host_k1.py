...
for x in range(6):
	n = 2**x
	data_config = "--nepochs " + str(num_epochs) + " --num_batches " + str(num_batches) + " --mini_batch_size " + str(n) + " --max_mini_batch_size " + str(n) + " --sls_type " + str(sls_type) + " --data_generation synthetic" + " --data_trace_file input_k1/dist_emb_j.log"
